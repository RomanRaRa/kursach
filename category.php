    ...
    <div id="wrapper">
        ...
        <section id="content">
                    ...
                    <div class="container">
                        <div class="col-2">
                            <div class="category-image">
                                <img src="http://localhost/kursach/images/products/category-show.png" alt="Phone" class="img-responsive">
            ...
            <div id="category-breadcrumb">
                <div class="container">
                    <ul class="breadcrumb">
                        <li><a href="http://localhost/kursach/index.php">Home</a></li>
                            ...
                            <div class="col-md-9 col-sm-8 col-xs-12 main-content">
                                ...
                                <div class="category-toolbar clearfix">
                                    <div class="toolbox-filter clearfix">
                                        ...
                                        <div class="view-box">
                                            <a href="http://localhost/kursach/category.php" class="active icon-button icon-grid"><i class="fa fa-th-large"></i></a>
                                            <a href="http://localhost/kursach/category-list.php" class="icon-button icon-list"><i class="fa fa-th-list"></i></a>
                                        </div><!-- End .view-box -->
                                        ...
                                        <div class="item item-hover">
                                            <div class="item-image-wrapper">
                                                <figure class="item-image-container">
                                                    <a href="http://localhost/kursach/product.php">
                                                        <img src="http://localhost/kursach/images/products/item2.jpg" alt="item1" class="item-image">
                                                        <img src="http://localhost/kursach/images/products/item2-hover.jpg" alt="item1  Hover" class="item-image-hover">
                                                    </a>
                                                </figure>
                                            ...
                                            <div class="item-meta-container">
                                                ...
                                                <h3 class="item-name"><a href="http://localhost/kursach/product.php">Phasellus consequat</a></h3>
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                        <div class="item item-hover">
                                            <div class="item-image-wrapper">
                                                <figure class="item-image-container">
                                                    <a href="http://localhost/kursach/product.php">
                                                        <img src="http://localhost/kursach/images/products/item1.jpg" alt="item1" class="item-image">
                                                        <img src="http://localhost/kursach/images/products/item1-hover.jpg" alt="item1  Hover" class="item-image-hover">
                                                    </a>
                                                </figure>
                                                <div class="item-price-container">
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                        <div class="item item-hover">
                                            <div class="item-image-wrapper">
                                                <figure class="item-image-container">
                                                    <a href="http://localhost/kursach/product.php">
                                                        <img src="http://localhost/kursach/images/products/item4.jpg" alt="item1" class="item-image">
                                                        <img src="http://localhost/kursach/images/products/item4-hover.jpg" alt="item1  Hover" class="item-image-hover">
                                                    </a>
                                                </figure>
                                                <div class="item-price-container">
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                        <div class="item item-hover">
                                            <div class="item-image-wrapper">
                                                <figure class="item-image-container">
                                                    <a href="http://localhost/kursach/product.php">
                                                        <img src="http://localhost/kursach/images/products/item10.jpg" alt="item1" class="item-image">
                                                        <img src="http://localhost/kursach/images/products/item10-hover.jpg" alt="item1  Hover" class="item-image-hover">
                                                    </a>
                                                </figure>
                                                <div class="item-price-container">
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                        <div class="item item-hover">
                                            <div class="item-image-wrapper">
                                                <figure class="item-image-container">
                                                    <a href="product.html">
                                                        <img src="http://localhost/kursach/images/products/item6.jpg" alt="item1" class="item-image">
                                                        <img src="http://localhost/kursach/images/products/item6-hover.jpg" alt="item1  Hover" class="item-image-hover">
                                                    </a>
                                                </figure>
                                                <div class="item-price-container">
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                        <div class="item item-hover">
                                            <div class="item-image-wrapper">
                                                <figure class="item-image-container">
                                                    <a href="http://localhost/kursach/product.php">
                                                        <img src="http://localhost/kursach/images/products/item9.jpg" alt="item1" class="item-image">
                                                        <img src="http://localhost/kursach/images/products/item9-hover.jpg" alt="item1  Hover" class="item-image-hover">
                                                    </a>
                                                </figure>
                                                <div class="item-price-container">
